...
import static com.example.user_service.utils.ApiUtils.ApiResult;
...
public class ApiExceptionController {
    ...
    public ApiResult unauthoriezedExHandle(Exception e) {
        log.info("[exceptionHandle] AccessDeniedException or UsernameNotFoundException ", e);
